...
public class consulter_visite extends AppCompatActivity {
            ...
            public void onClick(View v) {
                ...
                switch (v.getId()) {
                    ...
                    case R.id.btn_ok:
                        ...
                        Toast.makeText(getApplicationContext(), " Vous avez selectionner une visite qui se fait :  "+ uneVisite.codePraticien+ "/" + uneVisite.codeVisite ,   Toast.LENGTH_SHORT).show();
