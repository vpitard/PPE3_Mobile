...
public class ImportationVisiteur extends  AsyncTask<String,Void,ArrayList<Visiteur>> {
    @Override
           ...
           URL url = new URL(params[0]);
            ...
            if(httpResult== HttpURLConnection.HTTP_OK){
               ...
               // System.out.println(ligne);
                Gson gson=new Gson();
                listeVisiteur = gson.fromJson(ligne,new TypeToken<ArrayList<Visiteur>>(){}.getType());
